    ...
    getData:function(event) {
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                var tr="<tr>";
                if(result){
                    tr+="<td style='font-size: 38px; text-align: center; color: green; font-weight: bolder;'>"+ "Genuine Product."+"</td>";
                }else{
                    tr+="<td style='font-size: 38px; text-align: center; color: red; font-weight: bolder;'>"+ "Fake Product."+"</td>";
                }
                tr+="</tr>";
                t+=tr;
